...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->yieldContent('barraLateral'); ?>
    <div class="menu">
    <nav>
        <ul>
    ...
    <div>
        ...
        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td  onclick="location.href='/conta/show/<?php echo e($cliente->id); ?>'" style=" cursor:pointer; font-size: 1.5em; text-align: center; font-family: 'Yeon Sung', cursive;">
